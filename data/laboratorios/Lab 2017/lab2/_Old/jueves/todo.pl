...
mover(E,LP,E2) :- mover_rec(E,LP,E2), cambiar_turno(E), E2 = E.
...
mover_rec(E1,[H|[]],E2) :- movimiento_valido_mover(E1,H), realizar_movimiento(E1,H), not(hay_movimiento_siguiente(E1)).
mover_rec(E1,[H|T],E3) :- movimiento_valido_mover(E1,H), realizar_movimiento(E1,H), hay_movimiento_siguiente(E1), mover_rec(E1,T,E3).
...
hacer_jugada(E,LP,E2):-
	niveles_minimax(Niv),
	turno(E,J),
	evaluar_y_elegir(_,E,Niv,-20,20,_,MejorMov,J),
	arg(1,MejorMov,LP),
    mover(E,LP,E2).
